...
//api to get appointement
const listAppointement = async (req, res) => {
  try {
    const { userId } = req.body;   // ✅ FIXED
...
const verifyRazorpay = async (req, res) => {
  try {
    ...
    if(orderInfo.status === "paid") {
      await appointementModel.findByIdAndUpdate(orderInfo.receipt, { payment: true });
...
export { registerUser,loginUser,getProfile,updateProfile , bookAppointement, listAppointement , cancelAppointment,paymentRazorpay,verifyRazorpay}
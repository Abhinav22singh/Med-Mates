  ...
  return (
    <div className="px-6 py-12 bg-gray-50">
      <h1 className="text-3xl font-semibold text-gray-800 text-center">
        Top <span className="text-cyan-600">Doctors</span> To Book
      </h1>
      ...
      <div className="text-center mt-8">
        <button onClick={()=>{navigate(`/doctors`); scrollTo(0,0)}} className="px-6 py-2 bg-cyan-600 text-white font-medium rounded-lg shadow hover:bg-cyan-700 transition">
          MORE
        </button>
      </div>
    </div>

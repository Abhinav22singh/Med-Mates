...
const Appointment = () => {
  ...
  console.log("docInfo keys:", JSON.stringify(docInfo, null, 2)); // ← add this
  setDocInfo(docInfo);
};
  ...
  return (
    docInfo && (
      <div>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <div>
            <img
              className="bg-sky-300 w-full sm:max-w-72 rounded-lg"
              src={docInfo.image}
              alt=""
            />
          </div>
        ...
        <div className="sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700">
          ...
          {/* time show */}
          <div className="mt-4 flex items-center overflow-x-scroll w-full gap-3">
            {docSlots.length &&
    ...
    ${
      item.time === slotTime
        ...
        : "text-gray-500 border border-gray-300 hover:bg-sky-50"
    }`}
                >
          ...
          <button onClick={bookAppointement} className="bg-sky-600 text-white text-sm font-light px-14 py-3 rounded-full my-6">Book an Appointement</button>
        </div>
        {/* listing */}
